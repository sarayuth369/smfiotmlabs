...
const MATRIX: Record<AdminRole, Module[]> = {
  super_admin: [
    "dashboard","members","farms","devices","subscriptions","pricing","products","orders","plan_orders",
  ...
  sales: ["dashboard","members","subscriptions","products","orders","plan_orders","payments"],
