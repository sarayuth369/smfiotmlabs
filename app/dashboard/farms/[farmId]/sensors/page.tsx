...
import { sensorTypeLabel, sensorTypeIcon } from "@/lib/sensor-types";
...
export default async function FarmSensorsPage({
  ...
  const [userPlan, sensorUsage] = await Promise.all([
                    ...
                    {deviceSensors.map((s) => (
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          <span className="text-lg shrink-0">{sensorTypeIcon(s.sensor_type)}</span>
